...
//смена цвета окна при нажатии клавиш
...
class MyPanel extends JPanel
{
	public MyPanel()
	{
		...
		Action redAction=new MyAction("Red",
				...
				Color.red);
		Action greenAction=new MyAction("Green",
				new ImageIcon("green-ball.gif"),
				Color.green);
		add(new JButton(yellowAction));
		add(new JButton(blueAction));
		add(new JButton(redAction));
		add(new JButton(greenAction));
		//назначение гарячих клавиш
	...
	public class MyAction extends AbstractAction
	{
		...
		{
			//получение параметра и его названия
			putValue(Action.NAME, name);
			putValue(Action.SMALL_ICON, icon);
			putValue("color", c);
			//подсказка на кнопках
